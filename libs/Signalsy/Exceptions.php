...
//Unknown URL
class Signalsy_Missing_Required_Params_Exception extends  Signalsy_Exception {}

//предиспатч
class Signalsy_preDispatch_Exception extends  Signalsy_Exception {}

class Signalsy_Comet_Provider_Exception extends  Signalsy_Exception {}
class Signalsy_Comet_Connection_Exception extends  Signalsy_Exception {}